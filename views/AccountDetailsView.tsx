...
import { Camera, User, ArrowLeft, ChevronDown, Check, CheckCircle2, Mail, CloudUpload } from 'lucide-react';
...
export const AccountDetailsView: React.FC<AccountDetailsViewProps> = ({ 
  ...
  const [formData, setFormData] = useState<AccountDetails>({
    ...initialData,
    name: initialData.name || 'Fulano da Silva',
    username: initialData.username || 'meunomedeusuario'
  });
  ...
  const inputClass = "w-full bg-[#f2f2f2] dark:bg-white/5 py-4 px-4 text-[14px] font-mooli font-normal rounded-md outline-none border border-transparent focus:border-black dark:focus:border-white focus:ring-1 focus:ring-black dark:focus:ring-white transition-all text-black dark:text-white placeholder:text-gray-400";
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#121212] animate-in fade-in duration-500 flex flex-col">
      <header className="pt-12 pb-6 px-5 flex items-center justify-between sticky top-0 bg-white dark:bg-[#121212] z-10">
        ...
        <h2 className="font-amatic font-bold text-[34px] uppercase tracking-tight text-black dark:text-white leading-none absolute left-1/2 -translate-x-1/2">
          Editar Conta
        </h2>
        <button 
          onClick={handleSave} 
      ...
      <div className="flex flex-col items-center mt-2 mb-10">
        <div className="relative">
          <div 
            ...
            className="w-24 h-24 bg-[#f2f2f2] dark:bg-white/5 rounded-full flex items-center justify-center overflow-hidden cursor-pointer"
          >
            {formData.photo ? (
      ...
      <div className="flex-1 px-5 space-y-5 max-w-md mx-auto w-full">
        <section>
        ...
        <section>
          ...
          <div className="relative flex items-center w-full bg-[#f2f2f2] dark:bg-white/5 rounded-md border border-transparent focus-within:border-black dark:focus-within:border-white focus-within:ring-1 focus-within:ring-black dark:focus-within:ring-white transition-all text-black dark:text-white group">
            <span className="pl-4 pr-0.5 text-[15px] font-mooli font-normal text-gray-400 transition-colors">@</span>
            <input 
              type="text" 
        ...
        <section className="space-y-4">
          <div className="flex flex-col items-center justify-center space-y-3 pb-2 pt-4">
            ...
            <p 
              className="font-rubik text-center text-[13px] px-4 leading-relaxed"
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 border-2 border-gray-200 dark:border-white/10 rounded-md hover:bg-gray-50 dark:hover:bg-white/5 focus:bg-[#f7f7f7] dark:focus:bg-white/5 transition-all active:scale-95 focus:outline-none focus:border-black dark:focus:border-white focus:ring-1 focus:ring-black dark:focus:ring-white"
          >
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 border-2 border-gray-200 dark:border-white/10 rounded-md hover:bg-gray-50 dark:hover:bg-white/5 focus:bg-[#f7f7f7] dark:focus:bg-white/5 transition-all active:scale-95 focus:outline-none focus:border-black dark:focus:border-white focus:ring-1 focus:ring-black dark:focus:ring-white"
          >
            <Mail size={18} className="text-black dark:text-white" strokeWidth={2.5} />
