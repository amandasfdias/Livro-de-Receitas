...
export const AuthView: React.FC<AuthViewProps> = ({ onLoginSuccess, onContinueAsGuest, onGoogleLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-black dark:text-white flex flex-col items-center justify-center p-8 animate-in fade-in duration-700">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="font-inter text-[11px] font-bold uppercase tracking-widest">Google</span>
            </button>
            ...
            >
              ...
              <span className="font-inter text-[11px] font-bold uppercase tracking-widest">Convidado</span>
            </button>
          </div>
        </div>
